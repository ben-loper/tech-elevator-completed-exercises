<template>
  <div id="app">
    ...
    <shopping-search @filter-todos="handleSearch"/>
    <shopping-list :data="groceries" title="Grocery Store" :search="search" />
    <shopping-list :data="costco" title="Costco" :search="search" />
    <shopping-list :data="target" title="Target" :search="search" />
  </div>
</template>
